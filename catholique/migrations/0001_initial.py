# Generated by Django 3.1.2 on 2020-10-22 20:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('father_date_birth', models.DateField(blank=True, null=True)),
                ('mother_date_birth', models.DateField(blank=True, null=True)),
                ...
                ('first_profession_date', models.DateField(blank=True, null=True)),
                ('perpetual_profession_place', models.CharField(max_length=30)),
                ('perpetual_profession_date', models.DateField(blank=True, null=True)),
                ('deaconate_place', models.CharField(max_length=30)),
                ('deaconate_date', models.DateField(blank=True, null=True)),
                ('presbyterate_place', models.CharField(max_length=30)),
                ('presbyterate_date', models.DateField(blank=True, null=True)),
                ...
                ('date_patronal_feast', models.DateField(blank=True, null=True)),
                ('name_lunge', models.CharField(max_length=30)),
                ('none', models.CharField(max_length=10)),
            ],
            options={
                'ordering': ['first_name'],
            },
